            ...
            <aside className="modulessidebar-container">
                <ul className="modulessidebar-wrapper">
                    <li className="modulessidebar-li-item">
                        ...
                        <img src={topic} alt="topic" className="topic"/><span className="modulessidebar-li-content">Python Loops</span>
                        </Link>
                    </li>
                    <li className="modulessidebar-li-item">
                    ...
                    <li className="modulessidebar-li-item">
                        ...
                        <img src={assignment} alt="assignment" className="assignment"/><span className="modulessidebar-li-content">Assignment
                            1: Loops</span></Link>
                    </li>
                </ul>
            </aside>
            <main className="modules-main">
                <h2>Topic-1: Data Types</h2>
